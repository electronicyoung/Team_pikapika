...
uint8_t rotated_block[4] = { 0 };
uint8_t sub_block[4] = { 0 };

uint8_t sub_text[16] = { 0 };
uint8_t shift_text[16] = { 0 };
uint8_t mix_text[16] = { 0 };

uint8_t Hash_text[16] = { 0 };

uint8_t Rconstant[44] = { 0 };
...
*/
    ...
    int counts = plaintext_block(mesg, len);
