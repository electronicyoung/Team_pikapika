...
int main()
{
    ...
    for(int k=0;k<11;k++) {
       printf("round %d Key : ", k);
       for(int i=0; i<16; i++){
        printf("%x",No_of_Expanded_keys[k].keys[i]);
       }
       printf("\n");
    }
    ...
    */
    ...
    printf("round 10 enc_msg : ");
    for(int i=0; i<16; i++){
        printf("%x",encrypt_msg[i]);
    }
    printf("\n");
    
    inv_shiftrow(encrypt_msg, shift_text);
    printf("round 10 Shiftrow : ");
    for(int i=0; i<16; i++){
    ...
    inv_Subbyte(shift_text, sub_text, 16);
    printf("round 10 sub_byte : ");
    for(int i=0; i<16; i++){
        printf("%x",sub_text[i]);
    }
    printf("\n");
    ...
    for(int k=9;k>=1;k--) {
            ...
            RoundKeys(sub_text, No_of_Expanded_keys[k].keys, encrypt_msg);
            ...
            Invmixcolumn(encrypt_msg, mix_text);
            ...
            inv_shiftrow(mix_text, shift_text);
    ...
    RoundKeys(sub_text, key, encrypt_msg);
    printf("Round 0 enc_msg : ");
    for(int i=0; i<16; i++){
        printf("%x",encrypt_msg[i]);
    }
    printf("\n");
